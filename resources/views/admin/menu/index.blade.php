                            ...
                            <div class="row align-items-center">
                                <div class="col-md-4 my-2 my-md-0">
                                    <div class="input-icon">
                                        <input type="text" name="key" class="form-control" placeholder="Name" id="kt_datatable_search_query" value="{{request()->key}}"/>
                            ...
                            <tr data-row="0" class="datatable-row" style="left: 0px;">
                                ...
                                <td data-field="Actions">
                                    <span style="overflow: visible; position: relative; width: 125px;">
                                        <a href="{{route('menu.edit', $item['id'])}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
                                            <span class="far fa-edit"></span>
                                        </a>
                                        {{-- <a href="{{route('menu.destroy', $item['id'])}}" class="btn btn-sm btn-clean btn-icon btn-delete" title="Delete">
